...
if prompt := st.chat_input():
    ...
    """
      user_prompt_1=f"""
          ...
          **Three psychotherapist's responses**: 
          ...
          - If you have to give a very short answer, ask the mental patient a question related to him. However, if the mental patient says that he/she doesn't want to hear the question from the pyschotherapist, stop asking.]
    ...
    messages=[
      ...
      },
      {
        "role": "user",
        "content": f"""
Please only show the sentences from the '**Best response**:' section of what I provided below, with the quotes, or "" removed. Keep in mind that you should not seek answers from the "**Why the best response was chosen**:" part. Submit only **sentences** as output.
